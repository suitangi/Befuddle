...
console.log("window.discordSdk:", window.discordSdk);
console.log("typeof window.discordSdk:", typeof window.discordSdk);
console.log("window.location:", window.location.href);
console.log("User agent:", navigator.userAgent);
if (window.discordSdk) {
  const discordSdkInstance = new window.discordSdk();
